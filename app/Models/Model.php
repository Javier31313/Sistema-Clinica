...
class Model
{
    ...
    // public function create($data) {
    //     //INSERT INTO clientes (id,nombre_empresa, correo_empresarial) VALUES ('','','')
        
    //     $columns = array_keys($data);//Primero guardamos en la variable $columns las claves o llaves del array (id, nombre_empresa, correo_empresarial)
    //     $columns = implode(', ', $columns);// Segundo usamos la funcion implode que une elementos de un array en un string con dos parametros el separador y el array
    ...
    //     $insert_id = $this->connection->insert_id;// insert_id retorna el ultimo id, del ultimo registro que se acaba de insertar
